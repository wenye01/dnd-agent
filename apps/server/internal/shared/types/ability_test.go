...
func TestAbility_StringValues(t *testing.T) {
	tests := []struct {
		ability  Ability
		expected string
	}{
	...
	for _, tt := range tests {
		t.Run(tt.expected, func(t *testing.T) {
			if string(tt.ability) != tt.expected {
				t.Errorf("Ability string = %s, want %s", string(tt.ability), tt.expected)
			}
		})
	}
}

func TestSkill_StringValues(t *testing.T) {
	tests := []struct {
		skill    Skill
		expected string
	}{
	...
	for _, tt := range tests {
		t.Run(tt.expected, func(t *testing.T) {
			if string(tt.skill) != tt.expected {
				t.Errorf("Skill string = %s, want %s", string(tt.skill), tt.expected)
			}
		})
	}
}
