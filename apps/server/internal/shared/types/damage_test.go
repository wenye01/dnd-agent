...
func TestDamageType_StringValues(t *testing.T) {
	tests := []struct {
		damageType DamageType
		expected   string
	}{
		...
		{DamageNecrotic, "necrotic"},
		{DamagePiercing, "piercing"},
		{DamagePoison, "poison"},
		{DamagePsychic, "psychic"},
		{DamageRadiant, "radiant"},
	...
	for _, tt := range tests {
		t.Run(tt.expected, func(t *testing.T) {
			if string(tt.damageType) != tt.expected {
				t.Errorf("DamageType string = %s, want %s", string(tt.damageType), tt.expected)
			}
		})
	}
}

func TestCondition_StringValues(t *testing.T) {
	tests := []struct {
		condition Condition
		expected  string
	}{
	...
	for _, tt := range tests {
		t.Run(tt.expected, func(t *testing.T) {
			if string(tt.condition) != tt.expected {
				t.Errorf("Condition string = %s, want %s", string(tt.condition), tt.expected)
			}
		})
	}
}
