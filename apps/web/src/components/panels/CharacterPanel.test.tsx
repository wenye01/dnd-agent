...
/**
 * Helper: set up game state with a character(s) and render CharacterPanel.
 * Returns the rendered container for further queries.
 */
function renderWithCharacter(overrides?: Partial<Character>, partyMembers?: Character[]) {
  const characters = partyMembers ?? [createMockCharacter(overrides)]
...
describe('CharacterPanel', () => {
  ...
  it('should show Spell Slots for caster characters when expanded', () => {
    renderWithCharacter() // Wizard with spellSlots
  ...
  it('should render multiple party members', () => {
    ...
    renderWithCharacter(undefined, [char1, char2])
