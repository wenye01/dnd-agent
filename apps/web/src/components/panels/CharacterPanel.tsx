...
function StatChip({ icon: Icon, label, value, color = 'text-parchment' }: {
    ...
    <Panel title="Party" variant="parchment">
      <div className="space-y-3">
        {party.map((character) => (
          <div
            key={character.id}
            className="bg-cave/60 rounded-lg p-3 border border-gold/15 hover:border-gold/25 transition-all duration-200 group"
